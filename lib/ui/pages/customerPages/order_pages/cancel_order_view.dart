...
class Cancel_Cs_Page extends StatefulWidget {
  const Cancel_Cs_Page({super.key});

  @override
  State<Cancel_Cs_Page> createState() => _Cancel_Cs_PageState();
}

class _Cancel_Cs_PageState extends State<Cancel_Cs_Page> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<GetOrderBloc>().add(GetOrder(status: 'Cancel'));
    });
  }
