...
class Complete_Cs_Page extends StatefulWidget {
  const Complete_Cs_Page({super.key});

  @override
  State<Complete_Cs_Page> createState() => _Complete_Cs_PageState();
}

class _Complete_Cs_PageState extends State<Complete_Cs_Page> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<GetOrderBloc>().add(GetOrder(status: 'Completed'));
    });
  }
