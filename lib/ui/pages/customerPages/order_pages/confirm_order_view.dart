...
class Confirm_Cs_Page extends StatefulWidget {
  const Confirm_Cs_Page({super.key});

  @override
  State<Confirm_Cs_Page> createState() => _Confirm_Cs_PageState();
}

class _Confirm_Cs_PageState extends State<Confirm_Cs_Page> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<GetOrderBloc>().add(GetOrder(status: 'Confirm'));
    });
  }
