...
class _SpendingPageState extends State<SpendingPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<GetSpendingBloc>().add(GetSpendingInfo());
    });
  }
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 6),
                                Text(
                                  '${NumberFormat("#,###", "vi_VN").format(state.totalMonth)} đ',
                                  style: TextStyle(
                                    color: Colors.white,
                                    fontSize: 16,
                                    fontWeight: FontWeight.bold,
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 6),
                                Text(
                                  '${NumberFormat("#,###", "vi_VN").format(state.totalYear)} đ',
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: ButtonGradient(
                            text: 'thống kê\nchi tiết',
                            onPressed: () {
                              context.push(RoutePaths.spendingDetail);
                            },
