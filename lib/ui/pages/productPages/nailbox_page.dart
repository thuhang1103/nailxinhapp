...
class NailBoxPage extends StatefulWidget {
  final int category;
  const NailBoxPage({Key? key, required this.category}) : super(key: key);

  @override
  State<NailBoxPage> createState() => _NailBoxPageState();
}

class _NailBoxPageState extends State<NailBoxPage>
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          const SizedBox(height: 10),
          Center(child: Container(height: 10, color: MyColor.textColor)),
          const SizedBox(height: 10),
          Expanded(
            child:
                BlocBuilder<
