...
class OrderCancelDetailPage extends StatefulWidget {
  final int orderId;
  const OrderCancelDetailPage({Key? key, required this.orderId})
    : super(key: key);

  @override
  State<OrderCancelDetailPage> createState() => _OrderCancelDetailPageState();
}

class _OrderCancelDetailPageState extends State<OrderCancelDetailPage> {
  @override
  void initState() {
    super.initState();
