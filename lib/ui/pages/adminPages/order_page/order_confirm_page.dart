...
class OrderConfirmPageAD extends StatefulWidget {
  const OrderConfirmPageAD({Key? key}) : super(key: key);

  @override
  State<OrderConfirmPageAD> createState() => _OrderConfirmPageADState();
}

class _OrderConfirmPageADState extends State<OrderConfirmPageAD> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ManageOrderBloc>().add(GetOrderEvent(status: 'Confirm'));
    });
  }
