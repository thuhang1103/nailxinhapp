...
class OrderSpendingDetailPage extends StatefulWidget {
  final int orderId;
  const OrderSpendingDetailPage({Key? key, required this.orderId})
    : super(key: key);

  @override
  State<OrderSpendingDetailPage> createState() =>
      _OrderSpendingDetailPageState();
}

class _OrderSpendingDetailPageState extends State<OrderSpendingDetailPage> {
  @override
  void initState() {
    super.initState();
