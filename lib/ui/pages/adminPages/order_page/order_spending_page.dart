...
class OrderSpendingPage extends StatefulWidget {
  const OrderSpendingPage({Key? key}) : super(key: key);

  @override
  State<OrderSpendingPage> createState() => _OrderSpendingPageState();
}

class _OrderSpendingPageState extends State<OrderSpendingPage> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<ManageOrderBloc>().add(GetOrderEvent(status: 'Pending'));
    });
  }
