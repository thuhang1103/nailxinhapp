...
class OrderCompleteDetailPage extends StatefulWidget {
  final int orderId;
  const OrderCompleteDetailPage({Key? key, required this.orderId})
    : super(key: key);

  @override
  State<OrderCompleteDetailPage> createState() =>
      _OrderCompleteDetailPageState();
}

class _OrderCompleteDetailPageState extends State<OrderCompleteDetailPage> {
  @override
  void initState() {
    super.initState();
            ...
            return Column(
              children: [
                ...
                ElevatedButton(
                  ...
                  child: const Text('xác nhận đơn hoàn'),
                ),
              ],
            );
          },
