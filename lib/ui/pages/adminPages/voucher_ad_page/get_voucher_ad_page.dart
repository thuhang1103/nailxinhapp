...
class GetVoucherPage extends StatefulWidget {
  const GetVoucherPage({Key? key}) : super(key: key);

  @override
  State<GetVoucherPage> createState() => _GetVoucherPageState();
}

class _GetVoucherPageState extends State<GetVoucherPage> {
  @override
  void initState() {
    super.initState();

    context.read<ManageVoucherBloc>().add(GetVoucherEvent());
  }
    ...
    return Scaffold(
      ...
      body: BlocBuilder<ManageVoucherBloc, ManageVoucherState>(
        builder: (context, state) {
          return state.getvoucherState.maybeWhen(
            loading: () => LoadingView(),
