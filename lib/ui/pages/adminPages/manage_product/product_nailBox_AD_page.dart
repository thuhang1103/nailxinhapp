...
class ProductNailBoxADPage extends StatefulWidget {
  const ProductNailBoxADPage({Key? key}) : super(key: key);

  @override
  State<ProductNailBoxADPage> createState() => _ProductNailBoxADPageState();
}

class _ProductNailBoxADPageState extends State<ProductNailBoxADPage>
  ...
  void initState() {
    ...
    context.read<SearchProductCategoryBloc>().add(
      SearchProductByCategoryEvent(3),
    );
