...
class ProductNailADPage extends StatefulWidget {
  const ProductNailADPage({Key? key}) : super(key: key);

  @override
  State<ProductNailADPage> createState() => _ProductNailADPageState();
}

class _ProductNailADPageState extends State<ProductNailADPage>
  ...
  void initState() {
    ...
    context.read<SearchProductCategoryBloc>().add(
      SearchProductByCategoryEvent(2),
    );
