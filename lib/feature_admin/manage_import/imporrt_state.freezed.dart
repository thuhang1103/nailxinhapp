...
/// @nodoc
mixin _$ImportState {
  CommonState get importState => throw _privateConstructorUsedError;
...
abstract class $ImportStateCopyWith<$Res> {
  factory $ImportStateCopyWith(
    ImportState value,
    $Res Function(ImportState) then,
  ) = _$ImportStateCopyWithImpl<$Res, ImportState>;
  @useResult
  $Res call({CommonState importState});

  $CommonStateCopyWith<$Res> get importState;
}
...
class _$ImportStateCopyWithImpl<$Res, $Val extends ImportState>
  ...
  @override
  $Res call({Object? importState = null}) {
    return _then(
      _value.copyWith(
  ...
  @pragma('vm:prefer-inline')
  $CommonStateCopyWith<$Res> get importState {
    return $CommonStateCopyWith<$Res>(_value.importState, (value) {
      return _then(_value.copyWith(importState: value) as $Val);
    });
  }
}
...
abstract class _$$ImportStateImplCopyWith<$Res>
  ...
  factory _$$ImportStateImplCopyWith(
    _$ImportStateImpl value,
    $Res Function(_$ImportStateImpl) then,
...
class __$$ImportStateImplCopyWithImpl<$Res>
  ...
  __$$ImportStateImplCopyWithImpl(
    _$ImportStateImpl _value,
    $Res Function(_$ImportStateImpl) _then,
  ) : super(_value, _then);
...
class _$ImportStateImpl implements _ImportState {
  const _$ImportStateImpl({this.importState = const CommonState.initial()});

  @override
  @JsonKey()
  final CommonState importState;

  @override
  String toString() {
    return 'ImportState(importState: $importState)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.importState, importState) ||
                other.importState == importState));
  }

  @override
  int get hashCode => Object.hash(runtimeType, importState);
...
abstract class _ImportState implements ImportState {
  const factory _ImportState({final CommonState importState}) =
      _$ImportStateImpl;

  @override
  CommonState get importState;
